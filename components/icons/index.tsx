...
export const PartyIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  ...
  >
    ...
    <path d="M12.5 5.5L18 11l-8.5 8.5c-1.83 1.83-4.55 1.83-6.36 0-.63-.63-.98-1.4-1.09-2.2L2 22l4.7-.05c.8-.11 1.57-.46 2.2-1.09L17.5 12.3" />
  </svg>
)
...
export const SwipeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
